...
def procesar_tipo_df(tipo_df):
    ...
    columna = tipo_df.split('-')[1] + '_limpio'
    columnas = [columna+'_dom'] # [columna, columna+'_dom']
...
df_palabras.write_parquet(
    f'{RUTA_BASE}/ejecucion/NMF_dom.parquet'
)
