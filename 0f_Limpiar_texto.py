...
columnas_subconjunto = ['documento',
 ...
 'antecedente_dictamen_anonimizado']

df_muestra = pl.read_parquet(f'{RUTA_BASE}/../temporal/datos/muestra_secciones_2025.parquet')
df_muestra = (df_muestra.with_columns(pl.concat_str(pl.col('antecedente_anonimizado'),
                                                   pl.lit('\n'),
                                                   pl.col('dictamen_anonimizado'))
                                        .alias('antecedente_dictamen_anonimizado')
                                    )
                       )
